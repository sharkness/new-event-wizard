...
class Settings {
	...
	public function add_settings() {
		$fields = [
			...
			'a_setting' => [ // TODO
				'type'            => 'text',
				'label'           => esc_html__( 'xxx try this', 'tribe-ext-new-event-wizard' ),
				'tooltip'         => sprintf( esc_html__( 'Enter your custom URL, including "http://" or "https://", for example %s.', 'tribe-ext-new-event-wizard' ), '<code>https://wpshindig.com/events/</code>' ),
	...
	private function get_example_intro_text() {
		$result = '<h3>' . esc_html_x( 'Example Extension Setup', 'Settings header', 'tribe-ext-new-event-wizard' ) . '</h3>';
		$result .= '<div style="margin-left: 20px;">';
		$result .= '<p>';
		$result .= esc_html_x( 'Some text here about this settings section.', 'Settings', 'tribe-ext-new-event-wizard' );
		$result .= '</p>';
		$result .= '</div>';
